  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <a href="<?= base_url() ?>admin/info/add" class="btn btn-primary mt-2 mb-4"><i class="fa fa-plus"></i> Add </a>
          <table id="data-info" class="table table-bordered table-hover">
            <thead>
              <tr>
                <th width="6%">#</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?= $key->tanggal ?></td>
                <td>
                  <a href="<?= base_url() ?>admin/info/update/<?= $key->id ?>" class="btn btn-success btn-block" style="margin-bottom: 5px;"><i class="fa fa-edit"></i> Update </a>
                    <form action="<?= base_url() ?>admin/info/delete/<?= $key->id ?>" method="POST">
